class TrainingGoal:
   ...
   def __init__(self, race_type: str, duration_weeks: int):   #generally ensuring they put valid input (Idea for this section came from ChatGPT)
       self.race_type = race_type.lower().strip()                  #preventing typos through capitalization and spaces       
   ...
   def _race_distance(self, race_type: str) -> float:
       distances = {"5k": 5.0, "10k": 10.0, "half": 21.1, "full": 42.2}
       return distances.get(race_type.lower(), 0.0)
